...
const OfertaAcademica = () => {
  ...
  return (
    <div id="ofertaCont" className="homeComponent">
      ...
      <div id="ofertaContent" className="webfont2 textCont">
            ...
            <ul className={`dropdown-list ${isClassAdded ? "open" : ""}`}>
              <li>
                <h2>
                  ...
                  puerta a una carrera satisfactoria y gratificante con nuestro
                  programa de Licenciatura en Idiomas.
                </h2>
              </li>
              <li>
                <h3>
                  Explora diversas metodologías lingüísticas y matices
                  culturales, preparándote para conectar con estudiantes de todo
                  el mundo.
                </h3>
              </li>
              <li>
                <h3>
                  ...
                  comunidad de entusiastas de los idiomas que creen en el poder
                  transformador de la educación. Únete a nosotros para dar forma
                  al futuro en Idiomas e inspirar a la próxima generación de
              ...
              <li>
                <h3>
                  ...
                  Licenciatura en Idiomas y dar el primer paso hacia una carrera
                  emocionante y significativa en la educación.
                </h3>
              </li>
            </ul>
          </div>
            ...
            <ul className={`dropdown-list ${isClassAdded2 ? "open" : ""}`}>
              <li>
                <h2>
                  ...
                  Descubre el mundo de la compasión, el cuidado y la excelencia
                  en la atención sanitaria con nuestro programa de Grado en
                  Enfermería. En Sunshine University, estamos comprometidos a
                  nutrir la próxima generación de héroes de la salud que harán
                  una diferencia real en la vida de las personas y las
                  comunidades.
                </h2>
              </li>
              <li>
                <h3>
                  ...
                  aportan una gran experiencia clínica y conocimientos al aula.
                </h3>
              </li>
              <li>
                <h3>
            ...
            <ul className={`dropdown-list ${isClassAdded3 ? "open" : ""}`}>
              <li>
                <h2>
                  ...
                  embárcate en un viaje delicioso con nuestro programa de Grado
                  en Cocina. En Sunshine University, nos dedicamos a formar la
                  próxima generación de artistas culinarios y chefs que crearán
                  exquisitas experiencias culinarias que deleitarán los
                  sentidos.
                </h2>
              </li>
              <li>
        ...
        <div className="buttonDrowpdown">
          <div className="buttonInner">
            ...
            <ul className={`dropdown-list ${isClassAdded4 ? "open" : ""}`}>
              <li>
                <h2>
                  🏛️ ¡Diseña el mundo del mañana con un título de Arquitectura!
                  🏗️<br></br> Da rienda suelta a tu genio creativo y embárcate
                  en un viaje transformador con nuestro programa de Grado en
                  Arquitectura. En la Sunshine University, estamos dedicados a
                  nutrir a los arquitectos del futuro, que darán forma al mundo
                  con diseños innovadores y soluciones sostenibles.
                </h2>
              </li>
              <li>
                <h3>
                  Aprenda de arquitectos galardonados y líderes del sector a los
                  que les apasiona orientar a la próxima generación de
            ...
            <ul className={`dropdown-list ${isClassAdded5 ? "open" : ""}`}>
              <li>
                <h2>
                  ...
                  <br></br>
                  💻 Embárcate en un viaje dinámico en el mundo de la tecnología
                  y la innovación con nuestro programa de Grado en Ingeniería de
                  Software. En Sunshine University, estamos comprometidos a
                  equiparlo con las habilidades y conocimientos necesarios para
                  convertirse en un ingeniero de software competente, listo para
                  dar forma al panorama digital.
                </h2>
              </li>
              <li>
                <h3>
